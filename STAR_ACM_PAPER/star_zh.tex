...
%% Rights management
\setcopyright{acmlicensed}  % or acmconf? 先用樣版預設
\copyrightyear{2026}        % 預填今年或會議年份
\acmYear{2026}
\acmDOI{TBD}                % 尚未分配 DOI 時填 TBD
...
\newcommand{\textColorDel}[1]{\textcolor{red}{\sout{#1}}}  % 被刪掉的內容
\newcommand{\textHighlightModified}[1]{\colorbox{yellow}{#1}}   % 新增或修改後的內容
